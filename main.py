...
if __name__ == '__main__':
    ...
    # model.add(Conv2D(32, kernel_size=(2, 2), activation='relu', input_shape=(num_frames, num_features, 1)))
    ...
    # model.add(Conv2D(64, kernel_size=3, input_shape=(num_frames, num_features, 1)))
    ...
    # model.add(Conv2D(32, (2, 2), activation='relu', input_shape=(num_frames, num_features, 1)))
    # model.add(MaxPooling2D(pool_size=(2, 2)))
    ...
    # inp = Input(shape=(num_frames, num_features, 1))  # N.B. depth goes first in Keras!
